...
import useSubject from '../hooks/subject_hook.jsx'
import { useSchoolById } from '../../hooks/fetch_schools.jsx';
import { useTraining } from '../../hooks/training_hook.jsx';
...
function SchoolProfile() {
  ...
  // const { setFilter, filter, trainingsData, loadingTraining } = useTraining();
  const { setFilters, filters, trainingsData, loadingTraining } = useTraining();
  ...
  useEffect(() => {
    setFilters({ ...filters, trainings__school: data.id, requestor:null })
  }, [data])
  ...
  return (
    <div className='flex flex-col gap-2 w-full h-full'>
      ...
      <div className='flex gap-2 w-full h-full'>
        ...
        <div className='flex gap-1 flex-wrap border p-2 w-full'>
          {
