...
const EditSchoolModel = ({ id }) => {
    const { editSchoolModel, setEditSchoolModal } = useContext(ModalContext);
    const { grades, gradeLoading } = useGrades();
    const { school, setSchool, loading, updateSchool, updating, defaultGrade } = useSchoolById(id);
