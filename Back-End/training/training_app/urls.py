...
from .views import TrainingGetPost, TrainingById, TrainingsByTrainer, TrainingFilterView, TrainingStatisticsView, AllActiveTraining, TrainingByTrainerId, TrainingSheetView, TrainingDataView
